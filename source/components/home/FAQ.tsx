...
const FAQ = ({ faqs }: { faqs: any[] }) => {
  return (
    <section
      id="faq"
      className="w-full pt-32 flex flex-col gap-10 items-center justify-between"
    >
      <div className="flex-1 flex flex-col items-center justify-between w-full">
        <div className="flex flex-col gap-4 w-full">
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <path
                  d="M123 0.0175781L135 12.0176L123 24.0176L111 12.0176L123 0.0175781Z"
                  fill="#ffffff"
                />
              </svg>
            </div>
          ...
          >
            Find answers to all your questions about QueueWise in our
      ...
      >
        {faqs.map((faq: any, i) => (
          <QSet key={faq._id} i={i} faq={faq} />
        ))}
        {faqs.length === 0 && (
          <div className="pb-8 font-playfair uppercase w-full text-2xl">
